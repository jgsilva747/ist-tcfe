...
fprintf(file1, "R1 vcc base 50k \n");
fprintf(file1, "R2 base 0 5k \n\n");
fprintf(file1,"*gain stage\n");
fprintf(file1, "Q1 coll base emit BC547A\n");
fprintf(file1, "Rc vcc coll 4.9k\n");
fprintf(file1, "Re emit 0 3.5k\n\n");
...
fprintf(file2, "R1 vcc base 50k \n");
fprintf(file2, "R2 base 0 5k \n\n");
fprintf(file2,"*gain stage\n");
fprintf(file2, "Q1 coll base emit BC547A\n");
fprintf(file2, "Rc vcc coll 4.9k\n");
fprintf(file2, "Re emit 0 3.5k\n\n");
