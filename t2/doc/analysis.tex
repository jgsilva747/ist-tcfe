...
\includegraphics[width=0.8\linewidth]{natural_tab.pdf} 
...
\begin{figure}[H] \centering
\includegraphics[width=0.90\linewidth]{theo5_tab.pdf}
...
\end{equation}
 \newpage %toples
\begin{figure}[H] \centering
\includegraphics[width=1\linewidth]{freq_resp_tab.pdf}
...
\begin{figure}[H] \centering
\includegraphics[width=1\linewidth]{angle_tab.pdf}
